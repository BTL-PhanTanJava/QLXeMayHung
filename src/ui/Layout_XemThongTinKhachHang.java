...
public class Layout_XemThongTinKhachHang extends JFrame implements ActionListener {
	...
	public Layout_XemThongTinKhachHang() {
		...
		btnXoaTrang.setBounds(561, 233, 133, 25);
		...
		txtDiaChi.setBounds(179, 191, 515, 19);
		...
		txtTrangThai.setBounds(456, 150, 238, 20);
		getContentPane().add(txtTrangThai);
		txtTrangThai.setColumns(10);
		
		JComboBox cbGioiTinh = new JComboBox(s);
